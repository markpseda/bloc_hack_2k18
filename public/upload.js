document.getElementById("submit").addEventListener('click', function(){
    ...
    let hashedPass = SHA512(document.getElementById("pass").value);
    upload_file(uniqueID, topic, tags, hashedPass);
    let dateTime = Date();
    firebase.database().ref(`a-user/${sessionStorage.getItem('priv-storage-user')}/onUpload/`).set({
        uniqueID: uniqueID,
        topic: topic,
        timeStamp: dateTime,
        tags: tags,
...
function upload_file(uniqueID, topic, tags, hashedPass){
      let spaceRef = storage.ref();
      ...
      let imagesRef = spaceRef.child(`files/${uniqueID}`);
      let uploadTask=imagesRef.put(selectedFile);
      console.log("2");
      uploadTask.on('state_changed', function(snapshot){
            // Observe state change events such as progress, pause, and resumele.o
            ...
            // Handle unsuccessful uploads
              ...
              // For instance, get the download URL: https://firebasestorage.googleapis.com/...file:///c%3A/Users/Jonathan%20Wood/Desktop/temp.js
            ...
            //   console.log(downloadURL);
              ...
              // if (path is that of studentWork with all Work, then don't set, push)
...
//define SHA
    //Consumes:
    // - String str: String that you want to ge tthe hash of
    //Produces:
    // - String: a hash of str
    function SHA512(str) {
